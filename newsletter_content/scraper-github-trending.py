...
meditación_url = "https://www.regnumchristi.org/es/"+dt.strftime("%A")+"-"+str(dt.day)+"-de-"+dt.strftime("%B")+"-de-"+str(dt.year)
...
title.string = dt.strftime("%A").capitalize() +", "+str(dt.day)+" "+dt.strftime("%B").capitalize() +" "+str(dt.year)
